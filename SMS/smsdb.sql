...
-- admin 계정 데이터
insert into sms_admin values(1, 'admin', 'admin');
...
db table수정-대진, 구매내역 가격, 완료여부
ALTER TABLE SMS_quest ADD qst_price int;
ALTER TABLE SMS_quest ADD qst_comp int;
